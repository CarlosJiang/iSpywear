...
def cal_StdandMean(matrix):
	...
	for i in range(0, len(matrix)-1, 10):
		subset = []
		subset_iqr_1 = []
		subset_iqr_3 = []
		...
		subset_iqr_3.extend(matrix[i+5])
		subset_iqr_3.extend(matrix[i+6])
		subset_iqr_3.extend(matrix[i+7])
		subset_iqr_3.extend(matrix[i+8])
		subset_iqr_3.extend(matrix[i+9])
...
# File Paths
file_loc = '/Users/jianghe/Desktop/Mobile/iSpyWear2/MicrosoftBand/MachineLearning/DataSets/lowpass.txt'
...
writer = pd.ExcelWriter('/Users/jianghe/Desktop/Mobile/iSpyWear2/MicrosoftBand/MachineLearning/DataSets/Feature_lowpass_10.xlsx', engine='xlsxwriter')
