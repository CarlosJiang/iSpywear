...
def cal_StdandMean(matrix):
	...
	for i in range(0, len(matrix)-1, 30):
		if i != 0:
			i = i - 10
		subset = []
		subset_iqr_1 = []
...
writer = pd.ExcelWriter('/Users/jianghe/Desktop/Mobile/iSpyWear2/MicrosoftBand/MachineLearning/DataSets/Feature_testsample4_30_overlap_10_F.xlsx', engine='xlsxwriter')
