...
public class SensorDataDisplay extends Activity implements View.OnClickListener {
    ...
    private BandAccelerometerEventListener mAccelerometerEventListener = new BandAccelerometerEventListener() {
        ...
        public void onBandAccelerometerChanged(BandAccelerometerEvent bandAccelerometerEvent) {
            if (bandAccelerometerEvent != null) {
                appendToUI(String.format(" Acc.X = %f \n Acc.Y = %f\n Acc.Z = %f", bandAccelerometerEvent.getAccelerationX(),
    ...
    private BandGyroscopeEventListener mGyroscopeEventListener = new BandGyroscopeEventListener() {
        ...
        public void onBandGyroscopeChanged(final BandGyroscopeEvent bandGyroscopeEvent) {
            if (bandGyroscopeEvent != null) {
                appendToGyro(String.format("\n Gyro.X = %f \n Gyro.Y = %f\n Gyro.Z = %f", bandGyroscopeEvent.getAngularVelocityX(),
            ...
            SimpleDateFormat sdf = new SimpleDateFormat("HH:mm:ss.SSS");
            String str = sdf.format(new Date());
//            Gyro_sensorData  =df.format(bandGyroscopeEvent.getAngularVelocityX()) + "," + df.format(bandGyroscopeEvent.getAngularVelocityY()) + "," + df.format(bandGyroscopeEvent.getAngularVelocityZ()) +"," + "9" + "\n";
            Gyro_sensorData  =df.format(bandGyroscopeEvent.getAngularVelocityX()) + "," + df.format(bandGyroscopeEvent.getAngularVelocityY()) + "," + df.format(bandGyroscopeEvent.getAngularVelocityZ()) + "\n";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStopWrite = (Button) findViewById(R.id.btnStopWrite);
        ...
        btnStart.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                doWrite = true;
                mTextView.setText("Status：start writing");
            }
        });
    }
...
//                File targetFile = new File(sdCardDir.getCanonicalPath() + "/newSensorData"+"test2.txt");
                File targetFile = new File(sdCardDir.getCanonicalPath() + "/SensorData"+"Ypositive.txt");
